<div class="drawer">
  <input id="my-drawer-3" type="checkbox" class="drawer-toggle border-white ">
  <div class="drawer-content flex flex-col">
    ...
    <div class="w-full navbar bg-primary">
      ...
      <div class='flex-1'>
        <a href='./' class='btn btn-ghost normal-case text-xl text-white'>Wiener Wölkchen</a>
      </div>
      <div class="flex-none hidden lg:block text-white">
        <ul class="menu menu-horizontal">
          <!-- Navbar menu content here -->
          <li><a class='btn btn-ghost rounded-lg normal-case'>Navbar Item 1</a></li>
          <li><a class='btn btn-ghost rounded-lg normal-case'>Navbar Item 2</a></li>
        </ul>
      </div>
    </div>
    <!-- Page content here -->
